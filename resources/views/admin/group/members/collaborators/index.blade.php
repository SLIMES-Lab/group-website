...
@section('title', 'All Collaborators')

@section('content')
    <div class="container-fluid px-4">
        <div class="card mt-4">
            <div class="card-header">
                <h4>All Collaborators
                    <a href="{{ url('admin/group/members/add-collaborator') }}" class="btn btn-primary btn-sm float-end">Add
                        Collaborator</a>
                </h4>
            </div>
            <div class="card-body">
                ...
                <table class="table table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th>Name</th>
                            <th>Image</th>
                            <th>Current Position / Institution</th>
                            <th>Edit</th>
                            <th>Delete</th>
                        </tr>
                    </thead>
                    <tbody>
                        @foreach ($collaborators as $member)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ url('admin/group/members/edit-collaborator/' . $member->id) }}"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="{{ url('admin/group/members/delete-collaborator/' . $member->id) }}"
                                                    class="btn btn-danger">Delete</a>
                                            </div>
                                        </div>
                                    </div>
